...
## The only supported upgrade method for later releases of vyos, is by image upgrade
## The "system package" command family has been removed.
## Content here retained for reference, but commented out.

## Throws an error when sourced manually from cmd line
